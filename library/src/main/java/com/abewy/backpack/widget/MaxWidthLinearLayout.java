	...
	*/
	public static class LayoutParams extends LinearLayout.LayoutParams
	{
		...
		public LayoutParams(Context c, AttributeSet attrs)
		{
			...
			TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.MaxWidthLinearLayout);
			assert a != null;
			maxWidth = a.getLayoutDimension(R.styleable.MaxWidthLinearLayout_layout_maxWidth, Integer.MAX_VALUE);
		}
